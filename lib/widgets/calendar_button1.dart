...
class CalendarButton1 extends StatelessWidget {
  final String number;
  final String title;

  const CalendarButton1({Key? key, required this.number, required this.title})
      : super(key: key);
        ...
        return SizedBox(
          ...
          child: MaterialButton(
            ...
            onPressed: () async {
              ...
              blocBuilder.setInitialPeriod = pickedDate.toString();
              if (!(blocBuilder.getInitialPeriod == '' ||
            ...
            child: Row(
              children: [
                Text(
                  picker(number) == '' ? title : '${picker(number)}',
